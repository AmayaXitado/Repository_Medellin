...
<div class="mx-auto max-w-xl">
    <h1 class="mb-6 text-lg font-semibold text-slate-900 dark:text-slate-100">Nueva carpeta</h1>
    ...
    <form method="POST" action="{{ route('carpetas.store') }}"
        ...
        <div class="flex justify-end gap-3 border-t border-slate-200 pt-4 dark:border-slate-700">
            ...
            <button class="rounded-md bg-sky-600 px-4 py-2 text-sm font-medium text-white hover:bg-sky-700">Crear carpeta</button>
        </div>
    </form>
</div>

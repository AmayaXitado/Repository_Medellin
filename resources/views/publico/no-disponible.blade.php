...
<div class="text-center">
    <div class="mx-auto flex size-12 items-center justify-center rounded-full bg-slate-200 dark:bg-slate-700">
        <svg class="size-6 text-slate-600 dark:text-slate-300" fill="none" stroke="currentColor"
    ...
    <h1 class="mt-4 text-lg font-semibold text-slate-900 dark:text-slate-100">Este enlace no está disponible</h1>
